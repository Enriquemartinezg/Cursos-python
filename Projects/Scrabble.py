...
# After defining point_total, create a for loop that goes through the letters in word and adds the point value of each letter to point_total.You should get the point value from the letter_to_points dictionary. If the letter you are checking for is not in letter_to_points, add 0 to the point_total.
def score_word(word):
  point_total = 0
  for letter in word:
...
update_points_total() #Hay que llamar a la función, sino da la lista vacía
print(player_to_points)
player_word("Prof Reader", "PAPAYA")
