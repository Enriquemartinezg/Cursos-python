...
for transaction in daily_transactions_split:
  ...
  transactions_clean.append(transaction_clean) #sin este paso no se crea una lista de listas, sino que se meterían elementos sueltos en una única lista
...
#Now we want to know how much Thread Shed made in a day. First, define a variable called total_sales and set it equal to 0
total_sales = 0
...
# Define a function called color_count that takes one argument, color. The function should iterate through thread_sold_split and count the number of times the item is equal 
# to argument, color. Then, it should return this count
...
# Now, using the list colors, the string method .format(), and the function color_count, iterate through thread_sold_split and print a sentence that says how
#  many threads of each color were sold today
for color in colors:
  print("It has been sold {} pieces of {} color.".format(color_count(color), color))